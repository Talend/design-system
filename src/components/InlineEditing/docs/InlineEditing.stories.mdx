...
<Canvas>
	...
	<Story name="as H3">
		<InlineEditing.Text label="AS H3 Crawler name" defaultValue="Lorem ipsum dolor sit amet" renderValueAs="h3" />
	</Story>
...
- Button can be focused by using <kbd>Tab</kbd>
