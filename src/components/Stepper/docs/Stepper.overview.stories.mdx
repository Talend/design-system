...
<Canvas>
	<Story name="Vertical">
		<Stepper.Vertical>
			<Step.Validated>Lorem ipsum</Step.Validated>
			<Step.InProgress>Lorem ipsum</Step.InProgress>
			<Step.Enabled>Enabled state</Step.Enabled>
			<Step.Disabled>Disabled state</Step.Disabled>
			<Step.Error>Error state</Step.Error>
		</Stepper.Vertical>
	</Story>
</Canvas>
