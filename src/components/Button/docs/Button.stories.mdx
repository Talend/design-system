...
<Canvas
	mdxSource={`
<Button.Primary onClick={() => {}}>Basic Button</Button.Primary>
<Button.Primary onClick={() => {}} icon="talend-plus">
    Button with icon
</Button.Primary>
...
<Button.Primary disabled focusable onClick={() => {}}>
...
<Canvas
	mdxSource={`
<Button.Destructive onClick={() => {}}>Basic Button</Button.Destructive>
<Button.Destructive onClick={() => {}} icon="talend-plus">
    Button with icon
</Button.Destructive>
<Button.Destructive small onClick={() => {}}>
    Small Button
</Button.Destructive>
<Button.Destructive disabled onClick={() => {}}>
    Disabled Button
</Button.Destructive>
<Button.Destructive disabled focusable onClick={() => {}}>
    Disabled Focusable Button
</Button.Destructive>
`}
	withSource="open"
...
<Canvas
	mdxSource={`
<Button.Secondary onClick={() => {}}>Basic Button</Button.Secondary>
<Button.Secondary onClick={() => {}} icon="talend-plus">
    Button with icon
</Button.Secondary>
<Button.Secondary small onClick={() => {}}>
    Small Button
</Button.Secondary>
<Button.Secondary disabled onClick={() => {}}>
    Disabled Button
</Button.Secondary>
<Button.Secondary disabled focusable onClick={() => {}}>
    Disabled Focusable Button
</Button.Secondary>
`}
	withSource="open"
...
<Canvas
	mdxSource={`
<Button.Tertiary onClick={() => {}}>Basic Button</Button.Tertiary>
<Button.Tertiary onClick={() => {}} icon="talend-plus">
    Button with icon
</Button.Tertiary>
<Button.Tertiary small onClick={() => {}}>
    Small Button
</Button.Tertiary>
<Button.Tertiary disabled onClick={() => {}}>
    Disabled Button
</Button.Tertiary>
<Button.Tertiary disabled focusable onClick={() => {}}>
    Disabled Focusable Button
</Button.Tertiary>
`}
	withSource="open"
...
<Canvas
	mdxSource={`
<Button.Icon onClick={() => {}} icon="talend-plus">
    Button with icon
</Button.Icon>
<Button.Icon disabled onClick={() => {}} icon="talend-plus">
    Disabled Button
</Button.Icon>
<Button.Icon disabled focusable onClick={() => {}} icon="talend-plus">
    Disabled Focusable Button
</Button.Icon>
`}
	withSource="open"
