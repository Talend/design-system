...
<FigmaIframe
	light="https://www.figma.com/file/FaYIWpJeP6LwjWr78L8eAr/Forms?node-id=2260%3A0"
	dark="https://www.figma.com/file/FaYIWpJeP6LwjWr78L8eAr/Forms?node-id=2260%3A7"
/>
		...
		<Form>
			<Form.Fieldset legend="Frequency">
				...
				<Form.Row>
					...
					<Form.Time label="Repeat from" required value="14:k" hasError description="Repeat from is invalid" />
					<Form.Time label="Repeat to" required />
				</Form.Row>
			</Form.Fieldset>
			<Form.Buttons>
        ...
        <Form>
            <Form.Fieldset legend="Frequency">
                ...
                <Form.Row>
                    ...
                    <Form.Time label="Repeat from" required value="14:k" hasError description="Repeat from is invalid" />
                    <Form.Time label="Repeat to" required value="k" hasError description="Repeat to is invalid" />
                </Form.Row>
            </Form.Fieldset>
            <Form.Buttons>
                <Button.Secondary>Cancel</Button.Secondary>
