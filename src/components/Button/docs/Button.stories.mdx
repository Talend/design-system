...
<Canvas>
	...
	<Story name="primary--custom-icon">
		<Button.Primary
			onClick={action('clicked')}
			icon={
				<Icon name="src-https://www.flaticon.com/svg/vstatic/svg/4236/4236484.svg?token=exp=1614675138~hmac=6e7b87e55a414f936b285391dc2b414f" />
			}
		>
            Button with icon
		</Button.Primary>
