...
The Form Field could be composed by a label, an input and a small inline message (add link). 
...
For the password input (add link), a link could be added at the top right of the input.
