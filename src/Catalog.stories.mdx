...
<Canvas>
	<Story name="Buttons">
		<Button.Primary icon="icon-datagrid">Primary button</Button.Primary>
		<Button.Destructive icon="icon-datagrid">Destructive button</Button.Destructive>
		<Button.Secondary icon="icon-datagrid">Secondary button</Button.Secondary>
		<Button.Tertiary icon="icon-datagrid">Tertiary button</Button.Tertiary>
		<Button.Icon icon="icon-datagrid">Datagrid</Button.Icon>
	</Story>
</Canvas>
...
<Canvas>
	<Story name="Toggles">
		<Toggle icon="icon-datagrid">Toggle button</Toggle>
		<Toggle icon="icon-datagrid" disabled>
			Toggle button
		</Toggle>
	</Story>
</Canvas>
