...
<Canvas>
	<Story name="button">
		<Form.InputGroup label="InputBase" suffix={<Button.Secondary>Button</Button.Secondary>}>
			<Form.Text />
		</Form.InputGroup>
	</Story>
</Canvas>
...
<Canvas>
	<Story name="default">
		<Form.InputGroup label="InputBase" prefix="$" suffix=".00">
			<Form.Text />
		</Form.InputGroup>
	</Story>
</Canvas>
...
<Canvas>
	<Story name="disabled">
		<Form.InputGroup label="InputBase" prefix="$" suffix=".00" disabled>
			<Form.Number value="100" />
		</Form.InputGroup>
	</Story>
</Canvas>
...
<Canvas>
	<Story name="read-only">
		<Form.InputGroup label="InputBase" prefix="$" suffix=".00" readOnly>
			<Form.Number value="100" />
		</Form.InputGroup>
	</Story>
</Canvas>
