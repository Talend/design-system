...
<Canvas>
	...
	<Story name="primary--icon">
		<Button.Primary onClick={action('clicked')} icon="icon-plus">
			Button with icon
		</Button.Primary>
	</Story>
...
<Canvas>
	...
	<Story name="destructive--icon">
		<Button.Destructive onClick={action('clicked')} icon="icon-plus">
			Button with icon
		</Button.Destructive>
	</Story>
...
<Canvas>
	...
	<Story name="secondary--icon">
		<Button.Secondary onClick={action('clicked')} icon="icon-plus">
			Button with icon
		</Button.Secondary>
	</Story>
...
<Canvas>
	...
	<Story name="tertiary--icon">
		<Button.Tertiary onClick={action('clicked')} icon="icon-plus">
			Button with icon
		</Button.Tertiary>
	</Story>
